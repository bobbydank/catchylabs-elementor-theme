...
class Team_Slider extends Widget_Base {
	...
	public function get_title() {
		return __( 'Team Slider', 'cl-elementor' );
	}
    ...
    $repeater->add_control(
      'name', [
		...
		$repeater->add_control(
      'job_title', [
        'label' => __( 'Job Title', 'plugin-domain' ),
        'type' => \Elementor\Controls_Manager::TEXT,
        'default' => __( '' , 'plugin-domain' ),
        'label_block' => true,
      ]
      ...
      [
        ...
        'default' => __( 'Type your bio here. Please limit to 250 characters.', 'plugin-domain' ),
        'placeholder' => __( 'Type your bio here. Please limit to 250 characters.', 'plugin-domain' ),
      ]
    );
